...
function init() {
  ...
  const required = { MOMO_PARTNER_CODE: partnerCode, MOMO_ACCESS_KEY: accessKey, MOMO_SECRET_KEY: secretKey, MOMO_BASE_URL: baseURL, MOMO_REDIRECT_URL: redirectURL, MOMO_IPN_URL: ipnURL };
    ...
    const req = transport.request(url, {
      ...
      resp.on('end', () => {
        try {
          ...
          if (!result.payUrl) {
            console.log('MoMo payment URL not found or invalid response');
